...
const Intro = () => {
  return (
    <div
      className="flex w-full pb-10 justify-center bg-[#043873]"
      style={{
    ...
    >
      <div className="grid grid-cols-2">
        <div className="flex flex-col justify-center mx-40 my-auto">
          ...
          <p className="my-3">
            Design based software which allows you or your company to make your
            website, Create your design and SEO.
          </p>
